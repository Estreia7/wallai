...
export function TopMerchantsCard({
  ...
  return (
    <GlassCard>
      ...
      {merchants.length === 0 ? (
        <p className="py-4 text-center text-xs text-white/40">No expenses in this period.</p>
      ) : (
          ...
          {merchants.map((m, idx) => (
            ...
            >
              <div className="flex min-w-0 items-center gap-3">
                <span className="shrink-0 text-[10px] font-semibold text-white/30 tabular-nums">
                  #{idx + 1}
                </span>
